...
train_mostfits = False  # will nn train the mostfits?
...
for _ in range(hm_iterations):
    ...
    population = cat([population, mutate_population(population.clone(), mutation_chance, mutation_effect)], 0)
    print(flush=True)
